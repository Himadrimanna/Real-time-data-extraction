...
public class topgainers extends JFrame{
...
public static String getData() throws IOException
 {
      ...
      br.append("<html>"+
      "<body>");
      String url="https://www.moneycontrol.com/stocks/marketstats/nse-gainer/all-companies_-2/";
      ...
      Document doc= Jsoup.connect(url).get();
          try
          {
               ...
               if(row.select(".PR").text().equals("")){
                   ...
                   String lastprice = row.select(".green[width=45]").text();
 ...
 public static String getData000() throws IOException
{
 ...
 public static String getData10() throws IOException
 {
      ...
      br.append("<html>"+
      "<body>");
      String url="https://www.moneycontrol.com/stocks/marketstats/bse-gainer/all-companies_-1/";
      Document doc= Jsoup.connect(url).get();
          try
          {
               for(Element row:doc.select(".bsr_table.hist_tbl_hm tr"))
      ...
      Document doc= Jsoup.connect(url).get();
          try
          {
               ...
               if(row.select(".PR").text().equals("")){
                   ...
                   String name = row.select("td.green[width=45]").text();
 ...
 public topgainers() 
 {
    ...
    JLabel l1=new JLabel("TOPGAINERS");
    l1.setIcon(img7);
    l1.setFont(f1);
    l1.setBounds(30, 0,300 ,100);
