...
public class bond extends JFrame
{
    ...
    public static String getData() throws IOException
     {
          ...
          br.append("<html>"+
          "<body>");
          String url="https://www.moneycontrol.com/stocks/marketstats/nsehigh/index.php";
          Document doc= Jsoup.connect(url).get();
              try
              {
                   for(Element row:doc.select(".bsr_table.bsr_table930.MT20.PR.hist_tbl tr"))
                   {
                   if(row.select(".PR").text().equals("")){
                       continue;
                   }else{
                       String name = row.select(".PR>h3>span").text();
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String lastprice = row.select(".green").text();
                       String lastprice2 = row.select("td[width=185].red").text();
                       br.append("<font color=green>"+lastprice+"</font><font color=red>"+lastprice2+"</font><br><br>"); 
                   }
                   }  
              }
              catch (Exception e1)
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].30d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].50d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].150d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].200d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].pe").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].pb").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].uc").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].lc").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=90].vwap").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
     ...
     public static String getData000() throws IOException
    {
     ...
     public static String getData10() throws IOException
     {
          ...
          br.append("<html>"+
          "<body>");
          String url="https://www.moneycontrol.com/stocks/marketstats/bsehigh/";
          Document doc= Jsoup.connect(url).get();
              try
              {
                   for(Element row:doc.select(".bsr_table.bsr_table930.MT20.PR.hist_tbl tr"))
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=185].red").text();
                       String name1 = row.select("td[width=185].green").text();
                       br.append("<font color=red>"+name+"</font><font color=green>"+name1+"</font><br><br>"); 
                   }
                   }  
              }
              catch (Exception e1)
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].30d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].50d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].150d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].200d").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].pe").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].pb").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].uc").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].lc").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
          ...
          Document doc= Jsoup.connect(url).get();
              try
              {
                   ...
                   if(row.select(".PR").text().equals("")){
                       ...
                       String name = row.select("td[width=300].vwap").text();
                       br.append("  "+" "+name+"<br><br>"); 
                   }
                   }  
              }
     ...
     public bond() 
     {
        ...
        JLabel l1=new JLabel("LISTED BONDS");
